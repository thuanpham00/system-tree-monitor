window.addEventListener("load", function (e) {
    ...
    const serviceSick = document.querySelector(".service__sick");
    const serviceList = document.querySelector(".service__")
    btnLeft.addEventListener("click", function (e) {
        // console.log("hihi")
    });
    btnRight.addEventListener("click", function (e) {
        console.log("hihi");
        // let a = serviceList.offsetLeft;
        // serviceList.scroll(a + 100, 0);
    });
