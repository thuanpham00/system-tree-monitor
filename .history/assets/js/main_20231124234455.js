window.addEventListener("load", function (e) {
    ...
    document.querySelector(".service__link").addEventListener('click', function() {
        window.location.href = 'template.html'; // Thay 'ten-trang-mau.html' bằng đường dẫn đến trang HTML mẫu của bạn
    });
