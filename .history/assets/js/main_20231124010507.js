window.addEventListener("load", function (e) {
    ...
    // xử lý button rating
    const btnLeftRate = document.querySelector(".service__button.left1")
    const btnRightRate = document.querySelector(".service__button.right1")

    btnLeftRate.addEventListener
});
