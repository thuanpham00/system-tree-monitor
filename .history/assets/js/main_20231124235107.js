window.addEventListener("load", function (e) {
    ...
    let listSickTree = [
        {
            ...
            "text-1":
                "Bệnh bạc lá muộn (hay bệnh sương mai) là một bệnh nghiêm trọng gây hại cho cây cà chua. Bệnh do nấm Phytophthora infestans gây ra, nấm này phát triển mạnh trong điều kiện nhiệt độ thấp và ẩm ướt.",
            "text-2":
                "Trên lá: Vết bệnh ban đầu có màu xanh đậm như úng nước, sau đó chuyển sang nâu đen, vết bệnh lớn dần, nếu trời ẩm trên bề mặt lớp bệnh có lớp tơ màu trắng bao phủ, bệnh nặng sẽ làm thối nhũn lá, nếu thời tiết khô, vết trên lá cũng khô dòn dễ vỡ Trên thân cành: Bị bệnh từng đoạn dài, vỏ và ruột thân lúc đầu màu nâu hoặc thâm đen, sau đó thối ướt màu nâu đen.Trên quả: Vết bệnh ban đầu có màu xanh nhạt, sau đó chuyển sang nâu đen, vết bệnh lan rộng ra xung quanh, làm cho quả bị thối nhũn",
            "text-3":
        ...
        },
        {
            ...
            "text-1":
                "Bệnh bạc lá sớm do nấm Alternaria solani gây ra. Nấm bệnh tồn tại trong đất, trên tàn dư thực vật và trong hạt giống. Nấm bệnh phát triển mạnh trong điều kiện thời tiết ẩm ướt, nhiệt độ từ 20 đến 25 độ C.",
            "text-2":
    ...
    document.querySelector(".service__link").addEventListener("click", function (event) {
        event.preventDefault(); // Ngăn chặn hành động mặc định của sự kiện click
        displayInfoSickTree(1); // Thực hiện hàm displayInfoSickTree để thay đổi nội dung
        window.location.href = "your-new-page.html"; // Chuyển hướng trang đến trang mới
    });
});
