...
const formSignUp1 = document.querySelector(".form-SignUp");
const popup = document.querySelector(".pop-up");
formSignUp1.addEventListener("submit", async function (e) {
    e.preventDefault();
    const login = {
...
formSignIn.addEventListener("submit", async function(e) {
    ...
    const found = data.find(item => item.emailSignUp == email && item.passwordSignUp == pass)
})