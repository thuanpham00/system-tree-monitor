...
const createItem = (item) => {
  ...
  <a
    target="_blank"
    href="https://smartfarm.mard.gov.vn/2022/12/tai-lieu-ky-thuat-canh-tac-dau-tay-ca.html"
    class="news__link"
  >
    <img src="./assets/img/news/1.png" alt="" class="news__img" />
    <span class="news__date">25 Tháng 10, 2023 </span>
    <h4 class="news__heading">
      Tài liệu kỹ thuật canh tác dâu tây, cà chua và ớt chuông
    </h4>
  </a>
</div>`;
};
