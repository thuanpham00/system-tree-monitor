...
// const errTextName = document.querySelector(".textErrName");
// function errName() {
//     // errTextName.style.display = "block";
//     alert("nhap sai");
// }

// const nameSignUp1 = document.getElementById("nameSignUp");
// const textErrName = document.querySelector(".textErrName");

// nameSignUp1.addEventListener("submit", function () {
//     const value = nameSignUp1.value;
//     const regex = /^.{5,10}$/;

//     if (!regex.test(value)) {
//         textErrName.style.display = "block";
//     } else {
//         textErrName.style.display = "none";
//     }
// });
...
nameSignUp.addEventListener("submit", function() {
    const value = nameSignUp.value
    const minLength = nameSignUp.minLength
    const maxLength = nameSignUp.maxLength

    if(value.length < minLength || value.length > maxLength) {
        errTextName.style.display = "block"
    } else {
        errTextName.style.display = "none"
    }
})
...
function handleInputPass() {
    errTextPass.style.display = "none";
}

function errPass2() {
    errTextPass2.style.display = "block";
}

function handleInputPass2() {
    errTextPass2.style.display = "none";
}
