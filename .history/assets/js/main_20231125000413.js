window.addEventListener("load", function (e) {
    ...
    [...serviceLinkItem].forEach((item) =>
        item.addEventListener("click", function (e) {
            if (e.target.dataset.tree == "0") {
                const treeIndex = e.target.dataset.tree;
    ...
    function displayInfoSickTree(numberSick) {
        ...
        document.querySelector(".service__heading.title").textContent =
            sickNumber.name;
        document.querySelector(".sick__desc.desc-1").textContent =
            sickNumber.text1;
        document.querySelector(".sick__desc.desc-1.desc-2").textContent =
            sickNumber.text2;
        document.querySelector(".sick__desc.desc-1.desc-3").textContent =
            sickNumber.text3;
    }
